...
take a look in @sec-encode-vs-decode.
...
algorithm would behave in such situation? You find the answer in @fig-base64-algo1.
...
before the encoding process. First, think back at the 6-bit transformation performed by the encoder exposed in @sec-encoder-logic.
